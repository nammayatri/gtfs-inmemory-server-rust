...
ALTER TABLE public.bus_schedule_internal
    ALTER COLUMN entity_id DROP DEFAULT,
    ALTER COLUMN entity_id DROP NOT NULL,
    ALTER COLUMN route_id DROP DEFAULT,
    ALTER COLUMN route_id DROP NOT NULL,
    ALTER COLUMN service_type_id DROP DEFAULT,
    ALTER COLUMN service_type_id DROP NOT NULL,
    ALTER COLUMN schedule_type_id DROP DEFAULT,
    ALTER COLUMN schedule_type_id DROP NOT NULL;
