...
ALTER TABLE public.bus_schedule_trip_flexi_internal
    ALTER COLUMN calendar_id DROP DEFAULT,
    ALTER COLUMN calendar_id DROP NOT NULL,
    ALTER COLUMN route_number_id DROP DEFAULT,
    ALTER COLUMN route_number_id DROP NOT NULL,
    ALTER COLUMN schedule_trip_id DROP DEFAULT,
    ALTER COLUMN schedule_trip_id DROP NOT NULL,
    ALTER COLUMN waybill_id DROP DEFAULT,
