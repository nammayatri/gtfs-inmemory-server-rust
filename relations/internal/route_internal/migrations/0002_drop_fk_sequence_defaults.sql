...
ALTER TABLE public.route_internal
    ALTER COLUMN bus_service_type_id DROP DEFAULT,
    ALTER COLUMN bus_service_type_id DROP NOT NULL,
    ALTER COLUMN end_point_id DROP DEFAULT,
    ALTER COLUMN end_point_id DROP NOT NULL,
    ALTER COLUMN start_point_id DROP DEFAULT,
