...
#[openapi(
    ...
    paths(
        ...
        routes::upsert_station_etas_batch,
        routes::get_station_etas,
        routes::get_eta_variants,
        routes::upsert_eta_variant,
        routes::delete_eta_variant,
        routes::set_trip_eta_override,
        routes::clear_trip_eta_override,
        routes::list_active_trip_eta_overrides,
    ),
    components(schemas(
        models::EtaVariant,
        models::ActiveTripEtaOverride,
        models::StationEtaEntry,
        models::StationEtaRow,
        routes::StationEtaBatchUpsertRequest,
        routes::EtaVariantUpsertRequest,
        routes::TripEtaOverrideRequest,
        routes::TripEtaOverrideClearRequest,
